                ...
                <div class="page--title">
                    ...
                    <div class="filter--items--right">
                        ...
                        <div class="input--fuild">
                            <div class="search">
                                <button type="button" @click="openAddDialog()" class="button is-info">Add New</button>
                            </div>
                        </div>
        ...
        <div class="wrap--content">
           ...
           <template v-else>
                ...
                <div v-if="stockData.length">
                    <!-- <div v-for="item in stockData" :key="item">
                        <div class="card">
                            {{item.bill_number}}    
                        </div>
                    </div> -->
                    <swiper class="swiper" :options="swiperOption">
                            <swiper-slide style="height: 400px" v-for="item in resultStockData" :key="item.id" class="row">
                            <div v-for="(x, index) in item" :key="index" class="col-lg-3 col-md-4 parent-card">
                                    <div class="card" @click="openDialog(x)">
                                        {{x.bill_number}}
                                    </div>
                            </div>
                        </swiper-slide>
    ...
    export default {
        ...
        async fetchAllUsers() {
            ...
            async fetchAllItems(id, filters) {
                ...
                this.stockData = Object.values(this.stockData)
                console.log(Object.entries(this.stockData));
                var perChunk = 12 // items per chunk    
                    this.resultStockData = this.stockData.reduce((resultArray, item, index) => { 
                    ...
                    console.log('resultStockData',this.resultStockData); // result: [['a','b'], ['c','d'], ['e']]
