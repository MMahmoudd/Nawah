                        ...
                        <div class="col-12 col-lg-8 col-xl-6">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-sm-6">
                                    <b-field class="field-group">
                                        <b-input type="text" placeholder="First name" v-model="formData.Name" />
                                    </b-field>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <b-field class="field-group">
                                        <b-input type="email" placeholder="User Email" v-model="formData.email" />
                                    </b-field>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <b-field class="field-group">
                                        <b-input type="tel" placeholder="mobile" disabled v-model="formData.phone" />
                                    </b-field>
                                </div>
                                <!-- <div class="col-12">
                                    <b-field class="field-group">
    ...
    export default {
        ...
        methods: {
            ...
            submitForm() {
                ...
                // let data = {}
                this.formData.Name && formData.append('name', this.formData.Name)
                this.formData.email && formData.append('email', this.formData.email)
