...
<script>
    import List from '../../components/reports/products/list'
    import FilterItems from '../../components/reports/products/Filter'
    ...
    export default {
        ...
        data() {
            return {
                ...
                breadcrumb: [{
                    link: '',
                    label: this.$t('completeAll.productsReport')
                }]
            };
        },
        components: {
        ...
        methods: {
            ...
            async fetchAllItems(filters) {
                ...
                const products = await repoetsRepository.getAllProducts(this.page, this.limit, filters, this
                    .$route.params.id)
