            ...
            <div class="wrap--content">
                <div class="page--title">
                    ...
                    <div class="page--title--action ml-auto">
                        <router-link :to="{ path: '/homeSliderForm'}"
                            class="button is-primary">
                                {{$t('completeAll.addNewSlider')}}
                            </router-link>
                    </div>
                </div>
            </div>
        ...
        <div class="wrap--content">
            ...
            <template v-else>
                <list @fetchAllItems="fetchAllItems" :allItemsSelected="allItemsSelected"
                    @checkButtonSelectAll="checkButtonSelectAll" :data="fields" v-if="fields.length" />
                <template v-else>
...
<script>
    import List from '../../../components/home/homeSlider/list'
    import FilterItems from '../../../components/home/homeSlider/Filter'
    ...
    export default {
        ...
        data() {
            return {
                ...
                breadcrumb: [{
                    link: '',
                    label: this.$t('completeAll.sliders')
                }]
            };
        },
        components: {
        ...
        methods: {
            ...
            async fetchAllItems(filters) {
                ...
                const fields = await fieldsRepository.getAllSliders(this.page, this.limit, filters)
                this.total = fields.count;
                this.fields = fields.rows;
