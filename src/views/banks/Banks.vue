<template>
    <div class="banks">
                ...
                <div class="page--title">
                    ...
                    <div class="filter--items--right">
                        ...
                        <div class="input--fuild">
                            <div class="search">
                                <router-link to="/bankForm" type="button" class="button is-info">Add New</router-link>
                            </div>
                        </div>
        ...
        <div class="block--item" v-for="item in banks" :key="item.id">
        <div class="row align-items-center">
            <div class="col-12 col-sm-6 col-xl table--item">
                ...
                <div class="col-12 col-sm-6 col-xl table--item">
                    <div class="item--text">
                        <p v-bind:item="'item.trans.name'">{{item.trans.name}}</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-xl table--item">
                    <div class="block--item--title d-flex align-items-center item--text">
                        <div class="text--title">
                            <p v-bind:item="'item.number'">{{item.number}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-xl table--item">
                    <div class="item--text">
                        <p v-bind:item="'item.iban'">{{item.iban}}</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-12 col-xl item--text table--item">
                    <div class="all--item--action d-flex align-item-center">
                        <div class="all--item--action d-flex align-item-center">
                            <!--<router-link :to="'/stockDataSlider/' + item.id"  class="button--circle is-success-light"><i class="fas fa-eye"></i></router-link></i>-->
                            <router-link :to="'/bankForm/' + item.id"  class="button--circle is-primary-light"><i class="fas fa-pen"></i></router-link>
                ...
                <template v-else>
                    ...
                    <no-data text="No Banks have been created" />
                </template>
            </template>
    ...
    export default {
        ...
        async deleteStock(id) {
            ...
            async fetchAllItems(filters) {
                ...
                console.log(data)
                this.total = data.Banks.count
                this.banks = data.Banks.rows
