        ...
        <div class="page--head">
            <div class="wrap--content">
                <div class="page--title">
                    <div>
                        <h1 class="title--text">
                            {{$t('completeAll.termsAndCondition')}}
                        </h1>
                        <!-- Breadcrumb -->
    ...
    export default {
        ...
        data() {
            return {
                ...
                breadcrumb: [{
                    link: '',
                    label: this.$t('completeAll.termsAndCondition')
                }]
            };
        },
       ...
       components: {
        ...
        methods: {
            ...
            async getContent(lang) {
                const data = await repository.getTerms(lang)
                if(data){
                    this.data.title = data.title
                }
            },
            async updateContent(data) {
                const response = await repository.updateTerms(data)
