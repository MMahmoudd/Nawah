...
<script>
    import List from '../../components/pages/listSubscribe'
    ...
    export default {
        ...
        data() {
            return {
                ...
                breadcrumb: [{
                    link: '',
                    label: this.$t('completeAll.subscribes')
                }]
            };
        },
        components: {
        ...
        methods: {
            ...
            async fetchAllItems(filters) {
                ...
                const allData = await repository.getAllSubscribe(this.page, this.limit, filters)
