    ...
    export default {
        ...
        data() {
            return {
                ...
                breadcrumb: [{
                    link: '',
                    label: this.$t('completeAll.giftCarts')
                }]
            };
        },
       ...
       components: {
        ...
        methods: {
            ...
            async getContent(lang) {
                const data = await repository.getGiftCarts(lang)
                if(data){
                    this.data.title = data.title
                }
            },
            async updateContent(data) {
                const response = await repository.updateGiftCarts(data)
