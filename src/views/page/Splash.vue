    ...
    export default {
        ...
        data() {
            return {
                ...
                breadcrumb: [{
                    link: '',
                    label: this.$t('completeAll.walkThrough')
                }],
                image_base_url: null,
                imageOne: '',
                previewImageOne: '',
       ...
       components: {
        ...
        methods: {
            ...
            async getContent(lang) {
                const data = await repository.getSplash(lang)
                if(data){
            ...
            async updateContent(data) {
                const response = await repository.updateSplash(data)
