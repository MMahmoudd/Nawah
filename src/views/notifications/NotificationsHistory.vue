    ...
    <div class="stores">
        ...
        <div class="page--head">
            <div class="wrap--content">
                <div class="page--title">
                    <div>
                        <h1 class="title--text">
                             {{$t('completeAll.notificationsHistory')}}
        ...
        <div class="wrap--content">
            ...
            <template v-else>
                ...
                <template v-else>
                    <no-data :text="$t('completeAll.noNotifications')"/>
                </template>
            </template>
...
<script>
    import List from '../../components/notifications/listHistory'
    import FilterItems from '../../components/notifications/Filter'
    ...
    export default {
        ...
        data() {
            return {
                ...
                breadcrumb: [{
                    link: '',
                    label: this.$t('completeAll.notificationsHistory')
                }]
            };
        },
        components: {
        ...
        methods: {
            ...
            async fetchAllItems(filters) {
                ...
                const stores = await repository.fetchAllItemsHistory(this.page, this.limit, filters, this.$route.params.id)
                this.cities = stores.Notifications.rows;
                this.total = stores.Notifications.count;
