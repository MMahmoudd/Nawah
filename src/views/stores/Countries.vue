                ...
                <div class="page--title">
                    ...
                    <div class="page--title--action ml-auto">
                        <router-link :to="{ path: '/countryForm'}"
                            class="button is-primary">Add New Country Or Cities</router-link>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="wrap--content">
            ...
            <template v-else>
                <list @fetchAllItems="fetchAllItems" :allItemsSelected="allItemsSelected"
                    @checkButtonSelectAll="checkButtonSelectAll" :data="countries" v-if="countries.length" />
                <template v-else>
    ...
    export default {
        ...
        methods: {
            ...
            async fetchAllItems(filters) {
                ...
                const countries = await repository.getAllItems(this.page, this.limit, filters)
                this.total = countries.Geographies.count;
