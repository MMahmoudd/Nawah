    ...
    <div class="block--item no--checkbox">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-sm-6 col-xl-4 table--item">
                ...
                <div class="block--item--title d-flex align-items-center item--text">
                    <div class="text--title">
                        <router-link :to="`/productForm/${item.id}`" class="d-flex align-items-center">
            ...
            <div class="col-12 col-sm-6 col-xl table--item">
                <div class="block--item--title d-flex align-items-center item--text justify-content-center">
                    <div class="text--title">
                        <b-field class="field-group align-items-center">
                            <span class="mr-2">Featured</span>
                            <b-switch :value="item.featured" @input="updateProduct" :true-value="1" :false-value="0"></b-switch>
                        </b-field>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            async updateProduct(status) {
                ...
                const product = await productsRepository.updateProduct(this.item.id, formData);
            ...
            async deleteProduct(id) {
                ...
                if(product.status === 200){
                    ...
                    this.aleartMessage(product.message)
                }
            },
            formatDate(date){
