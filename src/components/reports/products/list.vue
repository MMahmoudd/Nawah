...
export default {
    ...
    methods:{
        ...
        async deleteProduct(id) {
            const products = await reportsRepository.deleteProduct(id)
            this.$emit('fetchAllItems')
            // this.aleartMessage(products.message)
        },
        // Delete Items
        async deleteProducts(ids) {
            const products = await reportsRepository.deleteProducts(ids)
            this.$emit('fetchAllItems')
            this.aleartMessage(products.message)
        },
        // Ban Items
         async updateProduct(id, data) {
            const products = await reportsRepository.updateProduct(id, data)
            this.$emit('fetchAllItems')
            this.aleartMessage(products.message)
        },
        fetchAllItems(){
